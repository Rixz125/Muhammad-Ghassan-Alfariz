...
@section('content')
 <div class="container card my-5 p-4">
    <div class="card-body">
        <h5 class="text-center">RINGKASAM ORDER</h5>
 ...
 <div class="fixed-bottom w-100 p-2 text-center text-white" style="background: #112646" onclick="createQrcode()">BAYAR SEKARANG</div>
@endsection
